...
**사이버펑크와 **Robo Recall** 에서 영감을 받아 제작하였으며,
플레이어가 적을 처치하는 다양한 방식을 통해 창의적인 플레이를 유도하도록 기획했습니다. 점수 시스템을 통해 반복 플레이에 재미를 더했습니다.**
### 장르
FPS, 1인칭
...
- 보스는 각 패턴은 개별 쿨타임을 가지며, LINQ를 활용해 쿨타임이 끝난 패턴만 선택적으로 발동하도록 구현.
